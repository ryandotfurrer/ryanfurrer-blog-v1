            ...
            }
            {
                props.text && (
                    <div>
                        ...
                        <p>Sign up on <a href="/chat-with-ryan.html" rel="noopener noreferrer"></a>Substack to be notified whenever I sent out a new email - typically 2 to 4 a month.</p>
<a href="/chat-with-ryan.html" rel="noopener noreferrer">Chat with Ryan</a>
