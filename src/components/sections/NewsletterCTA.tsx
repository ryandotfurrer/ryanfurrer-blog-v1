            ...
            }
            {
                props.text && (
                    <div>
                        ...
                        <p>Sign up on <a href="https://ryanfurrer.substack.com" rel="noopener noreferrer" {style}="">Substack</a> to be notified whenever I sent out a new email - typically 2 to 4 a month.</p>
