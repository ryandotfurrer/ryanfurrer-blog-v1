            ...
            <div className="colors-f flex flex-col justify-center relative w-full max-w-screen-md pt-9 pb-9 pl-9 pr-9 border-none rounded-lg">
                <div className="relative w-full"><div className="w-full">
                    <div className="flex flex-col items-center space-y-8">
                        ...
                        </div><div className="w-full"><div className="overflow-x-hidden"><div className="flex flex-wrap items-center -mx-2 lg:flex-nowrap justify-start" data-sb-field-path=".actions"><a href="https://www.getrevue.co/profile/theryanfurrer/" aria-label="Subscribe to The Ryan Furrer Newsletter" className="sb-component sb-component-block sb-component-button mb-3 mx-2 lg:whitespace-nowrap sb-component-button-primary" data-sb-field-path=".0 .0.url#@href .0.altText#@aria-label .0.elementId#@id .0.label#span[1] .0.icon#svg[1]"><span>Subscribe</span></a></div></div></div></div></div></div></div></div>
    )
}
